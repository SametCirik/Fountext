...
### Seçenek 1: Önceden Oluşturulmuş İkili Dosyaları İndirin (Çoğu Kullanıcı için Önerilir)

1. **[Yayınlar Sayfasına](https://github.com/SametCirik/Fountext-Screenwriting-Editor/releases) Gidin**

2. **En Son Sürümü İndirin**
   - En son yayına tıklayın (şu anda **v1.2**)
   - `Fountext-v1.2-Linux.tar.gz` dosyasını indirin

3. **Ayıklayın ve Çalıştırın**
   ```bash
   # Arşivi ayıklayın
   ...
   # İkili dosyayı çalıştırılabilir hale getirin (gerekirse)
   chmod +x Fountext
...
Bitti! Önceden oluşturulmuş ikili dosya tüm bağımlılıkları içerir ve kullanıma hazırdır.

### Seçenek 2: Kaynak Kodundan Derleyin
...
- **PyQt6**
- **CMake 3.15+**
- **C++ derleyicisi** (GCC 7+ veya Clang)
- **pybind11**
